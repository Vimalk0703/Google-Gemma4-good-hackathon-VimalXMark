...
COUNT_BREATHING_RATE = PromptRegistry.register(
    PromptTemplate(
...
DETECT_CHEST_INDRAWING = PromptRegistry.register(
    PromptTemplate(
...
CLASSIFY_BREATH_SOUNDS = PromptRegistry.register(
    PromptTemplate(
...
CLASSIFY_BREATH_SOUNDS_FROM_SPECTROGRAM = PromptRegistry.register(
    PromptTemplate(
...
CLASSIFY_BREATH_SOUNDS_BINARY = PromptRegistry.register(
    PromptTemplate(
...
CLASSIFY_BREATH_SOUNDS_FROM_TEXT = PromptRegistry.register(
    PromptTemplate(
