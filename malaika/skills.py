...
class SkillRegistry:
    ...
    def as_tool_descriptions(cls, step: str) -> str:
        ...
        skills.extend(
            ...
            if s.imci_step == "any" and s not in skills
        )
...
ASSESS_ALERTNESS = SkillRegistry.register(Skill(
...
ASSESS_SKIN_COLOR = SkillRegistry.register(Skill(
...
PARSE_CAREGIVER_RESPONSE = SkillRegistry.register(Skill(
...
DETECT_CHEST_INDRAWING = SkillRegistry.register(Skill(
...
COUNT_BREATHING_RATE = SkillRegistry.register(Skill(
...
CLASSIFY_BREATH_SOUNDS = SkillRegistry.register(Skill(
...
ASSESS_DEHYDRATION_SIGNS = SkillRegistry.register(Skill(
...
ASSESS_WASTING = SkillRegistry.register(Skill(
    name="assess_wasting",
...
DETECT_EDEMA = SkillRegistry.register(Skill(
    name="detect_edema",
...
CLASSIFY_IMCI_STEP = SkillRegistry.register(Skill(
...
GENERATE_TREATMENT = SkillRegistry.register(Skill(
...
SPEAK_TO_CAREGIVER = SkillRegistry.register(Skill(
